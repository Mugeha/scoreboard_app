...
### 🌍 Live Demo
Access the live scoreboard app: [Live on Render](https://scoreboard-app.onrender.com)
...
👉 [Read the blog here](https://mugeha585.hashnode.dev/building-a-live-scoreboard-web-app-with-lamp-stack-and-tidb)
